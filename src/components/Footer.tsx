    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center">
              <img src="/src/assets/blockchain.svg" alt="Logo" className="h-8 w-8 mr-2 invert" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/agency/login" className="text-gray-400 hover:text-white transition-colors">
                  Agency Login
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <address className="not-italic text-gray-400">
              ...
              <p className="mt-2">Email: info@certifytrust.com</p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col sm:flex-row justify-between">
          <p className="text-gray-400 text-sm">&copy; {currentYear} CertifyTrust. All rights reserved.</p>
